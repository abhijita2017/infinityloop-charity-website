<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('user/event/tickets') ? 'active' : '' }}"><a class="nav-link" href="{{ route('user_event_tickets') }}"><i class="fas fa-hand-point-right"></i> <span>Event Tickets</span></a></li>

            <li class="{{ Request::is('user/cause/donations') ? 'active' : '' }}"><a class="nav-link" href="{{ route('user_cause_donations') }}"><i class="fas fa-hand-point-right"></i> <span>Cause Donations</span></a></li>
